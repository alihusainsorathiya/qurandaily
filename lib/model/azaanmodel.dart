...
//
//     final azaanTime = azaanTimeFromJson(jsonString);

import 'dart:convert';

AzaanTime azaanTimeFromJson(String str) => AzaanTime.fromJson(json.decode(str));

String azaanTimeToJson(AzaanTime data) => json.encode(data.toJson());
...
class AzaanTime {
  ...
  factory AzaanTime.fromJson(Map<String, dynamic> json) => AzaanTime(
        code: json["code"],
        status: json["status"],
